...
from company_registration.views import ( CompanyRegisterView, CompanyLoginView, CompanyProfileUpdateView,
)
...
urlpatterns = [
    path("api/candidate/update/<int:pk>/", CandidateUpdateView.as_view(), name='candidate-update'),
